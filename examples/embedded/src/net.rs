use channels::io::{
	Contiguous, ContiguousMut, IntoReader, IntoWriter, Read, Reader,
	Write, Writer,
};
...
impl IntoReader<Socket> for Socket {
	fn into_reader(self) -> Socket {
		self
	}
}
...
impl IntoWriter<Socket> for Socket {
	fn into_writer(self) -> Socket {
		self
	}
}
